"""
URL configuration for netflix12 project.
...
urlpatterns = [
    ...
    path('kategori/<slug:kategori>/', kategori_resimleri, name='kategori_resimleri'),
    path('yeni-ve-populer/', yeni_ve_populer, name='yeni_ve_populer'),
